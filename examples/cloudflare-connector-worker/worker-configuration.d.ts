/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=examples/cloudflare-connector-worker/wrangler.jsonc examples/cloudflare-connector-worker/worker-configuration.d.ts` (hash: e4dde79f859214e01a08cdbed0b7d68e)
// Runtime types generated with workerd@1.20260820.1 2026-08-26 nodejs_compat
interface __BaseEnv_Env {
	SOURCE_DB: D1Database;
	DASHLOOM_URL: "https://your-dashloom.example";
	DASHLOOM_PRODUCT_ID: "11111111-1111-4111-8111-111111111111";
	SOURCE_NAME: "customer_d1";
	LOOKBACK_DAYS: 3;
	DASHLOOM_API_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DASHLOOM_URL" | "DASHLOOM_PRODUCT_ID" | "SOURCE_NAME" | "LOOKBACK_DAYS" | "DASHLOOM_API_KEY">> {}
}

...
export default function ChineseHome() {
  return <main lang="zh-CN">
    ...
    <footer><a className="brand" href="/zh"><span className="brand-mark" aria-hidden="true"><i /><i /><i /></span><span>Dashloom</span></a><p>让所有产品数据，变成下一步行动。</p><span className="footer-links"><a href="/docs">文档</a><a href="/status">部署状态</a><a href="/privacy">隐私</a><a href="/terms">条款</a><a href="https://github.com/dashloom-dev/dashloom/security">安全</a><i>© 2026 Dashloom</i></span></footer>
  </main>;
}

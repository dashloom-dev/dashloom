...
export default async function ReportsPage() {
  ...
  return <div className="app-page"><header className="app-page-head"><div><span>SCHEDULED REPORTS</span><h1>Reports</h1><p>Create reports now or schedule them every day, week, or month. Each report shows the dates and data sources it used.</p></div></header>

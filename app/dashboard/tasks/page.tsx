...
export default async function AgentTasksPage() {
  ...
  return <div className="app-page agent-task-center">
    <header className="app-page-head"><div><span>REPORT RUNS</span><h1>Report runs</h1><p>See whether each report is queued, complete, or failed, along with its token use. Failed reports can be retried here.</p></div><a className="app-secondary" href="/dashboard/agent">Create report</a></header>
    ...
    <section className="task-list app-panel">
      <div className="panel-title"><div><span>RECENT RUNS</span><h2>Latest 50 reports</h2></div><span className="status-pill">current workspace</span></div>
      {runs.map((run) => {

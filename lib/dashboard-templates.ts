...
export const dashboardTemplates = {
  ...
  cloudflare_operations: { eyebrow: 'CLOUDFLARE + SUPABASE OPERATIONS', title: 'Runtime, queue, storage, and delivery health', copy: 'Monitor Worker runtime, Queues backlog, R2 storage, Pages deployments, and Supabase backend evidence in one operational view.', metrics: ['requests', 'errors', 'cpu_time_p99', 'queue_backlog_messages', 'queue_oldest_message_age_seconds', 'queue_delivery_paused', 'r2_errors', 'pages_failed_deployments'], agent: 'Operations Analyst', agentPreset: 'operations_analyst' },

...
export const agentDefinitions = {
  portfolio_analyst: { name: 'Portfolio Analyst', dashboard: 'indie_hacker', focus: 'Compare product traction, acquisition, revenue, repository delivery, and operations. Rank the few opportunities and risks that most deserve an independent builder’s attention.', metrics: [] as string[] },
  ...
  operations_analyst: { name: 'Operations Analyst', dashboard: 'cloudflare_operations', focus: 'Detect operational regressions, deployment failures, backend and object-storage request shifts, unhealthy projects, storage growth, latency and CPU pressure, and stale telemetry. Prioritize user impact and reversible checks.', metrics: ['requests', 'errors', 'error_rate', 'subrequests', 'wall_time', 'cpu_time_p50', 'cpu_time_p99', 'd1_reads', 'd1_writes', 'r2_requests', 'r2_errors', 'r2_payload_bytes', 'r2_metadata_bytes', 'r2_objects', 'r2_pending_uploads', 'pages_deployments', 'pages_successful_deployments', 'pages_failed_deployments', 'pages_canceled_deployments', 'pages_production_deployments', 'pages_skipped_deployments', 'pages_deployment_duration_ms', 'pages_last_completed_deployment_success', 'pages_days_since_deployment', 'supabase_api_requests', 'supabase_auth_requests', 'supabase_realtime_requests', 'supabase_rest_requests', 'supabase_storage_requests', 'supabase_project_healthy', 'vercel_deployments', 'vercel_successful_deployments', 'vercel_failed_deployments', 'vercel_canceled_deployments', 'vercel_production_deployments', 'vercel_deployment_duration_ms', 'vercel_last_completed_deployment_success', 'vercel_days_since_deployment'] },
